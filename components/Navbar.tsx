        ...
        <div className="flex items-center justify-between h-16 sm:h-20 md:h-24">
          <div className="flex items-center space-x-2">
            ...
            <Link href="/" className="flex-shrink-0 ml-2 md:ml-0">
              <div className="relative w-24 sm:w-32 md:w-40 h-10 sm:h-12 md:h-14">
                <Image src="/images/logo.png" alt="ICN_FREEZE Logo" fill className="object-contain" />
              </div>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4 md:hidden">
            <Link href="/orders" aria-label={t("orders")}>
              <Truck size={24} className="text-gray-600 hover:text-green-600 transition" />
            </Link>
            <Link href="/cart" aria-label={t("cart")}>
              <ShoppingCart size={24} className="text-gray-600 hover:text-green-600 transition" />
            </Link>
          </div>
                  ...
                  <li key={href}>
                    <Link
                      ...
                      className={`px-4 py-2 text-lg font-semibold rounded-full transition-colors ${
                        isActive ? "bg-teal-600 text-white shadow-sm" : "text-gray-700 hover:text-teal-700 hover:bg-teal-50"
                      }`}
                    >
                      {t(key)}
                    </Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link href="/orders" className="text-gray-600 hover:text-teal-700 transition">
              <Truck size={24} />
            </Link>
            <Link href="/wishlist" className="text-gray-600 hover:text-teal-700 transition">
              <Heart size={24} />
            </Link>
            <Link href="/cart" className="text-gray-600 hover:text-teal-700 transition">
            ...
            {user ? (
              ...
              <>
                <Link href="/login" className="px-3 py-1 text-sm text-gray-700 rounded-md hover:text-teal-700 transition">
                  {t("login")}
                </Link>
                <Link href="/register" className="px-3 py-1 text-sm bg-teal-600 text-white rounded-md hover:bg-teal-700 transition">
                  {t("signup")}
                </Link>
              </>
            )}
              ...
              <div className="flex items-center space-x-2">
                <Link
                  ...
                  className={`px-2 py-1 rounded transition-colors ${
                    lang === "th" ? "bg-green-600 text-white" : "text-gray-700 hover:bg-gray-200"
                  }`}
                  onClick={() => setMobileOpen(false)}
                >
                  TH
                ...
                <Link
                  ...
                  locale="en"
                  className={`px-2 py-1 rounded transition-colors ${
                    lang === "en" ? "bg-green-600 text-white" : "text-gray-700 hover:bg-gray-200"
                  }`}
                  onClick={() => setMobileOpen(false)}
                >
                  EN
